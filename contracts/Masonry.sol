...
contract Masonry is ShareWrapper, ContractGuard {
    ...
    function getBuketPrice() external view returns (uint256) {
        return treasury.getBuketPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            buket.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        buket.safeTransferFrom(msg.sender, address(this), amount);
